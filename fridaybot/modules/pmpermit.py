...
if not PMPERMIT_PIC:
    WARN_PIC = "https://telegra.ph/file/ea0c6609553f0dfcf69e5.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By MrGOOD 🇮🇳"
)
USER_BOT_WARN_ZERO = "You Have Attempted To Spam Masters Inbox So Inorder To Avoid Over Spam , You Have Been Blocked By MrGOOD"

devs_id = [1144863351, 1356141222]

USER_BOT_NO_WARN = (
    "**Hello, This is MrGOOD's PM Protection Service ⚠️**\n\n"
    f"`MrGOOD is Busy Right Now !` \n"
